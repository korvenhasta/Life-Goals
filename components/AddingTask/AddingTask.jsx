    ...
    <div className={styles.addingTask + ' p-m'}>
      ...
      <Form onSubmit={onSubmit}>
        ...
        <FormLabel htmlFor="task"></FormLabel>
          ...
          <Input name="taskName" validationConfig={validationConfig.addingTask.taskName}/>
          <Subtitle>Estimated due date</Subtitle>
          <Paragraph>Add a date when you think this task should be completed</Paragraph>
            <Input type="date" name="taskDate" validationConfig={validationConfig.addingTask.taskDate}/>
            <Container>
              <Button variant={"button_primary"} type="submit">Add Task</Button>
